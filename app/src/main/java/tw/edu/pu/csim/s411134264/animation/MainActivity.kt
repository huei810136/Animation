package tw.edu.pu.csim.s411134264.animation
...
import tw.edu.pu.csim.s411134264.animation.ui.theme.AnimationTheme
...
fun Animation(m: Modifier){
    ...
    val backgroundColor by animateColorAsState(
        if (appear) Color.Transparent else Color.DarkGray,
        ...
        AnimatedVisibility(
            ...
            enter = fadeIn(
                ...
                animationSpec = tween(durationMillis = 5000))
                    + slideInHorizontally(animationSpec = tween(durationMillis = 5000)){ fullWidth ->
                    fullWidth / 3
                },
            ...
            exit = fadeOut(
                animationSpec = tween(durationMillis = 5000))
                    + slideOutHorizontally(animationSpec = tween(durationMillis = 5000)){ fullWidth ->
                fullWidth / 3
            }
